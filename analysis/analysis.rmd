...
library(ggplot2)
require(quantileCI)
ecdf_plot <- function(title, data, xinf, xsup, yinf, ysup, linetype=c("dotted", "solid", "dashed"), cols=c(15, 195, 150), img_name=FALSE) {
    ...
    geom_vline(xintercept=measurement.p50, linetype="dashed", size=size, alpha=alpha, color=measurement.color) +
    annotate(geom="text", x=inputs.p50, y=annotate_y, label="Median", angle=angle, color=inputs.color) + 
    geom_vline(xintercept=inputs.p50, linetype="dashed", size=size, alpha=alpha/2, color=inputs.color) +
    ...
    geom_vline(xintercept=measurement.p999, linetype="dashed", size=size, alpha=alpha, color=measurement.color) +
    annotate(geom="text", x=inputs.p999, y=annotate_y, label="99.9th", angle=angle, color=inputs.color) + 
    geom_vline(xintercept=inputs.p999, linetype="dashed", size=size, alpha=alpha/2, color=inputs.color) +
